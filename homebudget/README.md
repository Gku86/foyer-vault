...
4. Pour les notifications iPhone, mettre aussi à jour **Foyer Vault 1.3.1**, puis rouvrir HomeBudget depuis l’écran d’accueil (retirer l’icône et la remettre si le test n’arrive pas).
