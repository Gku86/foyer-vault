...
Mettre à jour le module en **1.3.5** pour que les notifications partent vraiment (signature). 1.3.4 rattache iPhone et ordinateur au nom d’utilisateur (1.3.3 identifiant unique par appareil, 1.3.2 d’un appareil vers un autre, 1.3.1 iPhone, 1.3.0 fichiers). Limites : 4 Mo par fichier, 64 Mo au total.
